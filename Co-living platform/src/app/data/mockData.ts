...
export const listings: Listing[] = [
  {
    ...
    description:
      "A sanctuary designed for focus and tranquility. Located in the heart of Gangnam, this space offers a retreat from the urban bustle with its soft neutral tones and architectural precision.",
    rating: 4.9,
    reviewCount: 42,
    host: {
      name: "Min-su Kim",
  ...
  },
  {
    ...
    description:
      "Experience the pinnacle of urban living. This loft in Hannam features soaring ceilings and an open-plan layout that encourages creativity and social connection.",
    rating: 5.0,
    reviewCount: 12,
    host: {
      name: "Seo-yeon Lee",
  ...
  },
  {
    ...
    description:
      "Located in the Brooklyn of Seoul, The Creative Hub is more than a home. It's a community of makers, thinkers, and innovators living under one beautifully designed roof.",
    rating: 4.8,
    reviewCount: 56,
    host: {
      name: "Jun-ho Park",
