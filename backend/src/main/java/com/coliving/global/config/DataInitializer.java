...
public class DataInitializer implements ApplicationRunner {
    ...
    private final com.coliving.admin.space.adapter.out.jpa.PriceRangePresetJpaRepository priceRangePresetJpaRepository;
    ...
    private void seedPriceRangePresets() {
        ...
        priceRangePresetJpaRepository.save(new com.coliving.admin.space.adapter.out.jpa.PriceRangePresetEntity("~ 50만 원", null, 500000, 0, true));
        priceRangePresetJpaRepository.save(new com.coliving.admin.space.adapter.out.jpa.PriceRangePresetEntity("50만 원 ~ 80만 원", 500000, 800000, 1, true));
        priceRangePresetJpaRepository.save(new com.coliving.admin.space.adapter.out.jpa.PriceRangePresetEntity("80만 원 ~ 100만 원", 800000, 1000000, 2, true));
        priceRangePresetJpaRepository.save(new com.coliving.admin.space.adapter.out.jpa.PriceRangePresetEntity("100만 원 ~ 150만 원", 1000000, 1500000, 3, true));
        priceRangePresetJpaRepository.save(new com.coliving.admin.space.adapter.out.jpa.PriceRangePresetEntity("150만 원 ~", 1500000, null, 4, true));
    }
