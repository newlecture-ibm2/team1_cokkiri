...
public class DataInitializer implements ApplicationRunner {
    ...
    private void seedSpacesFromDevDataset() {
        ...
        saveSpaceImageIfNotExists(lobby, "/api/uploads/lobby.png", ImageType.PHOTO, 1, true);
        ...
        saveSpaceImageIfNotExists(rooftop, "/api/uploads/rooftop.png", ImageType.PHOTO, 1, true);

        SpaceEntity gym = getOrCreateCommonSpace(
                "B1 헬스장", -1, new BigDecimal("300.00"), "[]", "24시간 무인 헬스장",
                50, "00:00~24:00", false, BigDecimal.ZERO);
        saveSpaceImageIfNotExists(gym, "/api/uploads/gym.png", ImageType.PHOTO, 1, true);
        ...
        saveSpaceImageIfNotExists(laundry, "/api/uploads/laundry.png", ImageType.PHOTO, 1, true);
        ...
        saveSpaceImageIfNotExists(library, "/api/uploads/library.png", ImageType.PHOTO, 1, true);
        ...
        saveSpaceImageIfNotExists(meetingRoom, "/api/uploads/meeting_room.png", ImageType.PHOTO, 1, true);
