...
erDiagram
    ...
    DEVICE_TYPE {
        ...
        VARCHAR code UK "코드 (LIGHT, HVAC, LOCK, WASHER, DRYER, CCTV, HEATER)"
    ...
    CONTROL_LOG {
        ...
        JSONB command_params "명령 파라미터 (JSON, 예: {temp: 24})"
    ...
    NOTIFICATION {
        ...
        VARCHAR type "알림 유형 (BOOKING_APPROVED / BOOKING_REJECTED / CONTRACT_CREATED / CONTRACT_EXPIRED / RESERVATION_APPROVED / VOC_REPLIED 등)"
        VARCHAR title "알림 제목"
        TEXT message "알림 내용"
