...
export function CommunityRichTextEditor({ value, onChange, placeholder, id }: Props) {
  ...
  }, []); // eslint-disable-line react-hooks/exhaustive-deps -- Quill 인스턴스는 마운트 시 1회
