...
### application-dev.yml
DB: `jdbc:postgresql://db:5432/coliving` (coliving/coliving123) | jpa: `show-sql:true, ddl-auto:update, sql.init.mode:never`
...
DB/JWT=환경변수참조, show-sql:false, logging=INFO
